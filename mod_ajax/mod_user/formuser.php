				...
				<div class="row">
					<div class="col-lg-6">
						<form method="post" name="formUser" action="" id="formUser" role="form">
							...
							<div class="form-group">
								<label>Desa</label>
								<input type="text" id="desa" name="desa" size="30" maxlength="30" value="<?php echo $desa; ?>" class="form-control" placeholder="Desa">
							</div>
							<div class="form-group">
								<label>Banjar</label>
								<input type="text" id="banjar" name="banjar" size="30" maxlength="30" value="<?php echo $banjar; ?>" class="form-control" placeholder="Banjar">
							</div>
							<div class="form-group">
								...
								<select id="ktrole" name="ktrole" class="form-control">
									...
									<option value='koordinator'<?php if ($tipeuser == 'koordinator') echo " selected";?>>Koordinator Jumantik</option>
									<option value='jumantik'<?php if ($tipeuser == 'jumantik') echo " selected";?>>Jumantik</option>
								</select>
							</div>
							<div class="form-group">
								<label>Status</label>
